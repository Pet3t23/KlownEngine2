 ...
 * @brief Renderer basado en Deferred Shading para la etapa gráfica principal.
 */
 ...
 * @brief Gestiona la renderización diferida utilizando múltiples buffers
 *        intermedios para almacenar información geométrica y de iluminación.
 *
